...
class GameAdmin(admin.ModelAdmin):
    ...
    search_fields = (
        'player_white__display_name',
        'player_black__display_name',
        'lichess_game_id',
    )
...
class GameAnalysisAdmin(admin.ModelAdmin):
    list_display = (
        'game', 'status', 'depth',
        'white_avg_centipawn_loss', 'black_avg_centipawn_loss',
        'white_blunders', 'black_blunders', 'analysed_at',
    )
    list_filter = ('status',)
...
class MoveEvaluationAdmin(admin.ModelAdmin):
    list_display = (
        'analysis', 'move_number', 'is_white',
        'move_san', 'centipawn_loss', 'classification',
    )
